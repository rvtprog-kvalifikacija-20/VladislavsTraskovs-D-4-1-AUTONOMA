...
<head>
    <title>Admin panele | Meklet</title>
...
<body>
   ...
   <?php include_once('includes/sidebar.php');?>
       ...
       <?php include_once('includes/header.php');?>
            ...
            <h2 class="main-title-w3layouts mb-2 text-center">Meklēt auto rezervāciju</h2>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <table class="table table-bordered">
                                ...
                                <?php
$ret=mysqli_query($con,"select bookingcar.ID as bid,bookingcar.FullName,bookingcar.BookingNumber,bookingcar.BookingDate,car.VehicleName,bookingcar.CreationDate from  bookingcar join  car on car.ID=bookingcar.VehicleID where bookingcar.FullName like '%$sdata%' ||bookingcar.BookingNumber like '%$sdata%'");
...
?>
            ...
            <td><?php echo $cnt;?></td>
                  ...
                  <td><a href="view-fourwheeler-booking.php?viewid=<?php echo $row['bid'];?>">Rezervācijas detaļas</a>
                </tr>
                <?php 
$cnt=$cnt+1;
} } else { ?>
