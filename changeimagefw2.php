...
$vehimg=md5($img).$extension;
    ...
    $query=mysqli_query($con, "update car set Image2 ='$vehimg' where ID='$imgid'");
    if ($query) {
...
?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Trasnporta bilde</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Jauna transporta bilde</label>
