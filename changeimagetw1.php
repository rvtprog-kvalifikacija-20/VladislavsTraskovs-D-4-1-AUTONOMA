...
$vehimg=md5($img).$extension;
    ...
    $query=mysqli_query($con, "update moto set Image1 ='$vehimg' where ID='$imgid'");
    if ($query) {
...
<head>
    <title>Admina panele | Motocikls</title>
...
?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Jauna motociklu bilde nr. 2</label>
