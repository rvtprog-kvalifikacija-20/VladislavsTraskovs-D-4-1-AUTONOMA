                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-6">
                                    <div class="name-input">
                                        <input type="password" name="currentpassword" id="currentpassword"  required='true' placeholder="Veca parole">
                                    </div>
                                </div></div>
                          <div class="row" style="padding-top: 20px">
                                <div class="col-lg-12 col-md-6">
                                    <div class="email-input">
                                        <input type="password" name="newpassword" id="newpassword" required='true' placeholder="Jauna porole">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-6">
                                    <div class="website-input">
                                         <input type="password" name="confirmpassword" id="confirmpassword" value="" required='true' placeholder="Apstiprinat jauno porole">
                                    </div>
                                </div>
...
<?php }?>
                            <div class="input-submit">
                                <button type="submit" name="submit">Izmainit</button>
                            </div>
                        </form>
                    </div>
                </div>
