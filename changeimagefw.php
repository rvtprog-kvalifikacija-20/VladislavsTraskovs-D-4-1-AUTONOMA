...
$vehimg=md5($img).$extension;
    ...
    $query=mysqli_query($con, "update car set Image ='$vehimg' where ID='$imgid'");
    if ($query) {
    $msg="Transports ir redigets!.";
  }
  else
    {
      $msg="Kludu. Meginiet vel reiz";
    }
...
<head>
    <title>Admin panele | Auto bilde</title>
...
<body>
    <div class="wrapper">
       ...
       <?php include_once('includes/header.php');?>
            ...
            <h2 class="main-title-w3layouts mb-2 text-center"> Transporta bilde</h2>
       
            <section class="forms-section">

             
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4"> Transporta bilde</h4>
    ...
    echo $msg;
                        ...
                        <?php
 $imgid=$_GET['editid'];
$ret=mysqli_query($con,"select * from  car where ID='$imgid'");
$cnt=1;
...
?>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Trasnporta nosaukums</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Transporta bilde</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Jana transporta bilde</label>
